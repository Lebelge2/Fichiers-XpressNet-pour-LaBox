...
#include "XpressNet.h"
#include <XpressNetMaster.h>      // https://github.com/Digital-MoBa/XpressNetMaster
#include "hmi.h"
...
bool XPressNet::begin() {
  ...
  XpressNet.setPower(1);  // Raill OFF
  return true;
}
//---------------------------------------------------------------
bool XPressNet::loop() {
...
void notifyXNetTrntInfo(uint8_t UserOps, uint16_t Address, uint8_t data) { // 0x42 Demande informations sur le décodeur d'accessoires
  ...
  XPressNet::XNetTrntInfo(Address, data);
}
//---------------------------------------------------------------------
...
//---------------------------------------------------------------------
void XPressNet::XNetTrntInfo(uint16_t Address, uint8_t data) {
